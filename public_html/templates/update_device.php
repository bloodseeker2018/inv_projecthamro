  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="update_device_form" name="device_form" onsubmit="return false">
        ...
        <div class="modal-footer">
          <button type="submit" value="submit" id="submitdev" class="btn btn-primary dashboardbtn"><i class="fa fa-save" style="color:white;">&nbsp;</i><font style="color:white;">Update changes</font></button>         
