...
<html>
	...
	<body class="managefield">		
		...
		<div class="container">
			...
			<form id="search_form" onsubmit="return false">
				<div class="input-group mb-2">
				  <input type="text" id="searchbranch" name="searchbranch" class="form-control" placeholder="Branch Name To Search">
			...
			<form action="branchreports.php" method="post">			
		...
		<?php include_once("./templates/updatebranch.php"); ?>		
	</body>
</html>	